...
const imgMass = ["../assets/taylor/taylor_1.png","../assets/taylor/taylor_2.png","../assets/taylor/taylor_3.png","../assets/taylor/taylor_4.png","../assets/taylor/taylor_5.png","../assets/taylor/taylor_6.png","../assets/taylor/taylor_7.png","../assets/taylor/taylor_8.png", "../assets/taylor/taylor_9.png", "../assets/taylor/taylor_10.png"];
const difficult = {
...
function fullGameSpace () {
    ...
    for (let i = 0; i < gameImgMass.length; i++) {
        ...
        setTimeout(function () {
            ...
            imgCover.src = '../assets/taylor/trumb.png';
